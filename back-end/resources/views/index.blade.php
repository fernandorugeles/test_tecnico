...
<head>
    ...
    <link href="{{ asset('/static/css/2.f7448fd7.chunk.css') }}" rel="stylesheet">
    <link href="{{ asset('/static/css/main.00108fee.chunk.css') }}" rel="stylesheet">
</head>
...
<body><noscript>You need to enable JavaScript to run this app.</noscript>
    ...
    <script>
        ! function(e) {
            ...
            var a = this["webpackJsonpfront-end"] = this["webpackJsonpfront-end"] || [],
                c = a.push.bind(a);
            a.push = r, a = a.slice();
    ...
    <script src="{{ asset('/static/js/2.7421eb4f.chunk.js') }}"></script>
    <script src="{{ asset('/static/js/main.67cf6ad3.chunk.js') }}"></script>
</body>
